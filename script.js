...
// menambha event listener ke floating button
...
//menambahkan event listerner ke modal bg
modal_bg.addEventListener('click', () => {
  // sembunyikan kembali
  hideModal();
})

//tambahkan event listerner submit ke add list form
...
function renderToHtml(){
  ...
  data_list_belanja.forEach((e, i)=>{
    ...
    <div class="card">
      ...
      <button onlick="handleDelete(${i})>Selesai</button>
    </div>
    `
